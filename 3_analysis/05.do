...
local dofilename "total_agri_expense_2017_18_fe"
cap log close
...
// total_edu_expense_365 total_food_expense_365 total_sfood_expense_365 total_agri_expense_365

keep if inlist(survey_year, 2017, 2018)

foreach var in total_agri_expense_365 {
