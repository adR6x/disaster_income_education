...
set more off
set rmsg on
local dofilename "04_hrvs_family_2017"
cap log close
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_2", clear
	
	merge 1:1 hhid psu district vdc member_id using "${data_raw}/Wave 2 - Household/Section_1", keepusing(s01q01)
	/*
	    Result                      Number of obs
    -----------------------------------------
    Not matched                         1,482
...
preserve 
	use "${data_raw}/Wave 2 - Household/Section_4", clear 
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_5a", clear
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_6a", clear
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_6b", clear 
...
merge 1:1 hhid psu district vdc using "${data_raw}/Wave 2 - Household/Section_6d", keepusing(s06q04b s06q04c)
...
preserve 
	use "${data_raw}/Wave 2 - Household/Section_9a2", clear 
...
merge 1:1 hhid psu district vdc using "${data_raw}/Wave 2 - Household/Section_9a3", keepusing (s09q31a)
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_9c", clear // Household level!!
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_9d", clear
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_9e", clear
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_9f", clear 
...
/*
    ...
    -----------------------------------------
    Not matched                         2,955
        from master                     2,955  (_merge==1)
        from using                          0  (_merge==2)

    Matched                             3,050  (_merge==3)
    -----------------------------------------
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_10", clear // Household level!!
...
/*
    ...
    -----------------------------------------
    Not matched                         4,974
        from master                     4,974  (_merge==1)
        from using                          0  (_merge==2)

    Matched                             1,031  (_merge==3)
    -----------------------------------------
*/
...
*===================*
preserve
	use "${data_raw}/Wave 2 - Household/Section_12a", clear
...
/*
  Result                      Number of obs
    -----------------------------------------
    Not matched                         2,419
        from master                     2,419  (_merge==1)
        from using                          0  (_merge==2)

    Matched                             3,586  (_merge==3)
    -----------------------------------------
*/
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_13a", clear
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_13b", clear
...
preserve
	use "${data_raw}/Wave 2 - Household/Section_13c", clear
...
/*
 Result                      Number of obs
    -----------------------------------------
    Not matched                         5,945
        from master                     5,945  (_merge==1)
        from using                          0  (_merge==2)

    Matched                                60  (_merge==3)
    -----------------------------------------
	
	Interesting that there were 3215 households that received tranfers last year but this year its just 60
*/
...
//Provided donations? 
merge 1:1 hhid psu district vdc using "${data_raw}/Wave 2 - Household/Section_13d", keepusing (s13q23)
...
//Public Programs
preserve
	use "${data_raw}/Wave 2 - Household/Section_14a", clear 
