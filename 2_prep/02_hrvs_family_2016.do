...
merge m:1 hhid psu district vdc using "${data_raw}/Wave 1 - Household/Section_0", keepusing (s00q15 s00q16 s00q17)
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_2", clear
	
	merge 1:1 hhid psu district vdc member_id using "${data_raw}/Wave 1 - Household/Section_1", keepusing(s01q01)
	/*
	    Result                      Number of obs
    -----------------------------------------
    Not matched                         1,482
	...
	*/
	...
	gen edu_hh_head = s02q02 if  s01q01 == 1
...
preserve 
	use "${data_raw}/Wave 1 - Household/Section_4", clear 
...
merge 1:1 hhid psu district vdc using `sec_4', keepusing (hhid psu district vdc rent_expense_30 rent_expense_365 total_utilities_expenditure_365 total_utilities_expenditure_30 s04q04b s04q05 s04q32b_1 s04q32b_2 s04q32b_3 s04q32b_4 s04q32a s04q32c s04q33b_1 s04q33b_2 s04q33b_3 s04q33b_4 s04q33a s04q33c)
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_6a", clear
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_6b", clear 
...
merge 1:1 hhid psu district vdc using "${data_raw}/Wave 1 - Household/Section_6d", keepusing(s06q04b s06q04c)
...
preserve 
	use "${data_raw}/Wave 1 - Household/Section_9a2", clear 
...
merge 1:1 hhid psu district vdc using "${data_raw}/Wave 1 - Household/Section_9a3", keepusing (s09q31a)
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_9c", clear 
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_9d", clear
...
/*
 Result                      Number of obs
    -----------------------------------------
    Not matched                         1,284
        from master                     1,284  (_merge==1)
        from using                          0  (_merge==2)

    Matched                             4,716  (_merge==3)
    -----------------------------------------
*/
assert _merge != 2
drop _merge
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_9e", clear
...
preserve
	use "${data_raw}/Wave 1 - Household/Section_9f", clear 
...
/*
 Result                      Number of obs
    -----------------------------------------
    Not matched                         3,128
        from master                     3,128  (_merge==1)
        from using                          0  (_merge==2)

    Matched                             2,872  (_merge==3)
    -----------------------------------------
*/
assert _merge != 2
drop _merge
...
/*
 Result                      Number of obs
    -----------------------------------------
    Not matched                         5,263
        from master                     5,263  (_merge==1)
        from using                          0  (_merge==2)

    Matched                               737  (_merge==3)
    -----------------------------------------
*/
...
*===================*
preserve
	use "${data_raw}/Wave 1 - Household/Section_12a", clear
...
/*
    ...
    -----------------------------------------
    Not matched                         3,206
        from master                     3,206  (_merge==1)
        from using                          0  (_merge==2)

    Matched                             2,794  (_merge==3)
    -----------------------------------------
*/
...
merge 1:1 hhid psu district vdc using `sec_13c', keepusing(total_ireceived_365 ireceived_edu)

/*
 Result                      Number of obs
    -----------------------------------------
    Not matched                         5,333
        from master                     5,333  (_merge==1)
        from using                          0  (_merge==2)
...
//Provided donations? 
merge 1:1 hhid psu district vdc using "${data_raw}/Wave 1 - Household/Section_13d", keepusing (s13q23)
